<script lang="ts">
  ...
  const signup = () => {
    userAuthStore.signup('mp@mercury.fan', 'Password123!')
  }
...
<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
  <div class="rounded-lg bg-white px-6 py-8 shadow sm:px-10">
    <form class="mb-0 space-y-6" on:submit|preventDefault="{signup}">
      <div>
      ...
      <div>
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          <input
            ...
            class="pr-8" />
          <div
            class="absolute inset-y-0 right-0 flex cursor-pointer items-center justify-start pr-2"
            aria-hidden="true"
