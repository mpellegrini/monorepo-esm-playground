...
<div
  ...
  {#each collectibles as collectible}
    <a
      href="/collectible/{collectible.id}"
      class="fade-in lg:-20 group relative cursor-pointer text-sm duration-300">
      <div
        class="fade-in group-hover:shadow-me square aspect-w-1 aspect-h-1 shadow-me relative w-full overflow-hidden rounded-xl bg-gray-100 duration-300 lg:group-hover:scale-[1.01]">
        <!--        <div-->
        <!--          class="-->
